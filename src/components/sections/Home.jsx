    ...
    return (
        <section id="home" className="min-h-screen flex items-end justify-start">
            <div className="max-w-4xl mx-auto px-6 mb-10">
                <h1 className="text-4xl font-bold"><span className="italic">Hola</span> <WinkFace/> I'm Andrea Jacho</h1>
                <p className="mt-4">
                    Computer Science student from <span className="text-yellow-400">Ecuador</span>, based in Oregon. Passionate about cloud services, 
