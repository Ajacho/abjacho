  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <div className="transition-all duration-300 my-10 mt-30" ></div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* col-1 */}
            <div className="flex flex-col items-center justify-center">
                <div className="hidden md:flex about-image">
                    {/* Picture of me */}
                    <img
                        src="./andrea.jpg"
                        alt="Andrea Jacho"
            ...
            <div className="max-w-4xl mx-auto px-6 mb-10">
                ...
                <span className="italic">Hola</span> <WinkFace /> <br/> I'm Andrea Jacho
                </h1>
                <p className="mt-4">
                ...
                </a>{" "} (June 2025), originally from Ecuador and now based in Oregon. I’m passionate about cloud computing, 
                web development, and user interface design, and I’m excited to contribute to and grow within the fast-moving 
                world of technology.
                </p>
